    ...
    return (
        <div className="primary">
            <div className="primary__details">
                <h1 className="primary__heading" aria-level="1" role="heading">Branding & website design agency</h1>
                ...
                <button type="" className="primary__btn" tabIndex="0">Learn more</button>
            </div>
        </div>
    )
}
